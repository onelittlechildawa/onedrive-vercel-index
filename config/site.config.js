...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'lijiaan@onelittlechild.onmicrosoft.com',
  ...
  googleFontLinks: ['https://fonts.lug.ustc.edu.cn/css2?family=Fira+Mono&family=Inter:wght@400;500;700&display=swap'],
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/onelittlechildawa',
    },
  ],
